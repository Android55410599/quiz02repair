...
public class AddMember extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add = (Button) findViewById(R.id.btnaddmember_599);
		close = (Button) findViewById(R.id.btnclose_599);
		close.setOnClickListener(this);
		add.setOnClickListener(this);
	}

	private boolean add() {
		e5 = (EditText) findViewById(R.id.e5_599);
		e6 = (EditText) findViewById(R.id.e6_599);
